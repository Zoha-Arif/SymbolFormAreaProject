...
mainpath = '/Volumes/LANDLAB/projects/sfa/supportfiles/streamlines/2019_tractmeasure'; 
cd '/Volumes/LANDLAB/projects/sfa/supportfiles/streamlines/2019_tractmeasure'; 
...
tables = {}; 
Headers = {'subjectID','structureID', 'nodeID', 'fa', 'x_coords', 'y_coords', 'z_coords', 'StreamlineCount'};
Tlong = cell2table(cell(0,8),'VariableNames', Headers);
...
for i = 1:(length(subfolders)) 
    ...
    subpathCSV = dir([subpath, '/*.run-1.round_2.ventral_temporal_parietal_occipital_rois.no_inflation.cleaned']); 
        
    %cd into file containing .csv file
    if ~isempty(subpathCSV)
        cd(subpathCSV(1).name);
        ...
        Tnew.StreamlineCount = T.StreamlineCount;
...
%add only tracts of interest
Tlong_new = table; 

% lhvwfa-parietal
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11125tolhvwfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11126tolhvwfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11126tolhvwfa'));
idx_tp4 = find(strcmp(Tlong.structureID, 'trackfreesurfer11157tolhvwfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3; idx_tp4], :);
rowsToAdd.structureID = repmat("lhvwfap", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];

Tlong_new = [Tlong_new; rowsToAdd]; 

% lhnfa-parietal
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11125tolhnfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11126tolhnfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11126tolhnfa'));
idx_tp4 = find(strcmp(Tlong.structureID, 'trackfreesurfer11157tolhnfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3; idx_tp4], :);
rowsToAdd.structureID = repmat("lhnfap", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% rhvwfa-parietal
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer12125torhvwfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer12126torhvwfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer12126torhvwfa'));
idx_tp4 = find(strcmp(Tlong.structureID, 'trackfreesurfer12157torhvwfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3; idx_tp4], :);
rowsToAdd.structureID = repmat("rhvwfap", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% rhnfa-parietal
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer12125torhnfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer12126torhnfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer12126torhnfa'));
idx_tp4 = find(strcmp(Tlong.structureID, 'trackfreesurfer12157torhnfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3; idx_tp4], :);
rowsToAdd.structureID = repmat("rhnfap", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% lhvwfa-occipital
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11119tolhvwfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11120tolhvwfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11143tolhvwfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3], :);
rowsToAdd.structureID = repmat("lhvwfao", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% lhnfa-occipital
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11119tolhnfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11120tolhnfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11143tolhnfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3], :);
rowsToAdd.structureID = repmat("lhnfao", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% rhvwfa-occipital
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11119torhvwfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11120torhvwfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11143torhvwfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3], :);
rowsToAdd.structureID = repmat("rhvwfao", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
% rhnfa-occipital
idx_tp1 = find(strcmp(Tlong.structureID, 'trackfreesurfer11119torhnfa'));
idx_tp2 = find(strcmp(Tlong.structureID, 'trackfreesurfer11120torhnfa'));
idx_tp3 = find(strcmp(Tlong.structureID, 'trackfreesurfer11143torhnfa'));

rowsToAdd = Tlong([idx_tp1; idx_tp2; idx_tp3], :);
rowsToAdd.structureID = repmat("rhnfao", height(rowsToAdd), 1); 
rowsToDelete = rowsToAdd.StreamlineCount < 100;
rowsToAdd(rowsToDelete, :) = [];
...
for s = 1:length(subIDs)
    ...
    %Streamline count changes for each object!
    %Tshort.StreamlineCount(s) = Tlong.StreamlineCount(Sidx(1));
...
table_path_format_tshort = fullfile(mainpath, 'TshortTOIS.csv');
table_path_format_tlong = fullfile(mainpath, 'TlongTOIS.csv');
